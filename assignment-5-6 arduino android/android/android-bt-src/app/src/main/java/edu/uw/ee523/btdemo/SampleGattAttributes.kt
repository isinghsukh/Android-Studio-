...
//    var HEART_RATE_MEASUREMENT_UUID = UUID.fromString("00002a37-0000-1000-8000-00805f9b34fb")
    var TEMPERATURE_MEASUREMENT_UUID = UUID.fromString("00002B37-0000-1000-8000-00805f9b34fb")
...
//    var HEART_RATE_SERVICE_UUID = UUID.fromString("0000180d-0000-1000-8000-00805f9b34fb")
    var TEMPERATURE_SERVICE_UUID = UUID.fromString("0000180E-0000-1000-8000-00805f9b34fb")
